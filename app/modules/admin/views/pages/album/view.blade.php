...
@section('content')
	...
	{{Form::model($album,array('route'=>array('admin_post_editAlbum',$album->id),'class'=>'formAdmin form-horizontal','files'=>true))}}
		...
		<div class="type_lang" id="en">
			...
			<div class="form-group">
				<div class="col-sm-10 col-sm-offset-2">
                	...
                	<div id="preview_img" >
                		<img src="{{asset('')}}{{$album->urlhinh}}" alt="" width="320">
                		<input type="hidden" name="imgbk" value="{{$album->urlhinh}}">
                	</div>
				</div>
	...
	function openKCFinder() {
	    window.KCFinder = {
	        callBack: function(url) {
	            ...
	            img.src = url;
	            img.onload = function() {
	                div.innerHTML = '<img id="img" src="' + url + '" />' + '<input type="hidden" name="file" value="' + url+ '" />';
